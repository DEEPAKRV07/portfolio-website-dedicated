  ...
  experience: {
    ...
    categories: [
      ...
      },
      {
        ...
        kicker: 'CAREER MILESTONE',
        title: 'Data & Analytics Engineering Contributor',
        subtitle: 'Quality Threads',
        sections: [
          {
            heading: 'ROLE & RESPONSIBILITIES',
            content: 'Built automated analytics reporting pipelines, structured feature extraction routines, and relational database management routines in Python and SQL.',
          },
          {
            heading: 'ENGINEERING CONTRIBUTIONS',
            bullets: [
              'Automated data analytics & feature extraction script development in Python',
              'Structured SQL database schema & query optimization',
              'Automated report generation and dataset formatting workflows',
            ],
          },
        ],
        tags: ['Python', 'SQL', 'Data Analytics', 'Pipeline Automation'],
        actions: [],
      },
    ],
  },
