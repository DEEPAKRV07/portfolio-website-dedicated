    ...
    categories: [
      {
        ...
        skills: [
          { id: 'yolov8', label: 'Machine Learning', position: [-9.8, 5.5, 2.5], name: 'Machine Learning', category: 'AI / ML', usedIn: ['SightMate', 'Football Analysis System'], tags: ['Algorithms', 'Model Training', 'Scikit-Learn'] },
          { id: 'bytetrack', label: 'Deep Learning', position: [-9.2, 2.2, 0.8], name: 'Deep Learning', category: 'AI / ML', usedIn: ['Football Analysis System', 'SightMate'], tags: ['Neural Networks', 'Spatial Reasoning'] },
          { id: 'opencv', label: 'Computer Vision', position: [-5.2, 6.2, 3.2], name: 'Computer Vision', category: 'AI / ML', usedIn: ['SightMate', 'Football Analysis System', 'MSME Center'], tags: ['Real-Time Vision', 'Frame Processing'] },
          { id: 'fast-scnn', label: 'Generative AI', position: [-10.5, 3.6, -1.0], name: 'Generative AI', category: 'AI / ML', usedIn: ['FORCRUX Studio', 'SightMate'], tags: ['LLMs', 'Prompt Engineering', 'RAG'] },
        ],
      },
      {
        id: 'dl-category',
        ...
        position: [6.8, 3.8, -1.8],
        skills: [
          { id: 'pytorch', label: 'TensorFlow', position: [5.2, 6.2, -3.2], name: 'TensorFlow', category: 'AI Tools', usedIn: ['SightMate (TFLite)'], tags: ['On-Device Inference', 'TFLite'] },
          { id: 'tensorflow', label: 'PyTorch', position: [9.8, 5.5, -2.5], name: 'PyTorch', category: 'AI Tools', usedIn: ['Football Analysis System', 'Custom Vision Models'], tags: ['Model Training', 'Deep Learning'] },
          { id: 'ml-kit', label: 'YOLOv8', position: [4.2, 2.0, 2.2], name: 'YOLOv8', category: 'AI Tools', usedIn: ['SightMate', 'Football Analysis System'], tags: ['Object Detection', 'Real-Time Vision'] },
          { id: 'kmeans', label: 'OpenCV', position: [9.2, 2.2, -0.8], name: 'OpenCV', category: 'AI Tools', usedIn: ['SightMate', 'Football Analysis System', 'MSME Center'], tags: ['Image Geometry', 'Video Processing'] },
        ],
      },
      {
        id: 'systems-category',
        ...
        position: [-6.8, -3.8, -1.8],
        skills: [
          { id: 'playwright', label: 'Python', position: [-9.8, -5.5, -2.5], name: 'Python', category: 'Development', usedIn: ['Google Maps Platform', 'SightMate', 'Football Analysis'], tags: ['Core Language', 'AI/ML Engineering'] },
          { id: 'sqlite', label: 'JavaScript', position: [-9.2, -2.2, -0.8], name: 'JavaScript', category: 'Development', usedIn: ['FORCRUX Studio', 'Kaatchi Media'], tags: ['ES6+', 'Async/Await', 'DOM Logic'] },
          { id: 'concurrency', label: 'React', position: [-5.2, -6.2, -3.2], name: 'React', category: 'Development', usedIn: ['FORCRUX Studio', 'Kaatchi Media'], tags: ['UI Components', 'State Management'] },
          { id: 'pandas', label: 'Next.js', position: [-4.2, -2.0, 2.2], name: 'Next.js', category: 'Development', usedIn: ['FORCRUX Studio Platform'], tags: ['Full-Stack', 'SSR', 'App Router'] },
        ],
      },
      {
        id: 'lang-category',
        ...
        position: [6.8, -3.8, 1.8],
        skills: [
          { id: 'python', label: 'Three.js', position: [9.8, -5.5, 2.5], name: 'Three.js', category: 'Mobile / DevOps', usedIn: ['3D Portfolio Website'], tags: ['WebGL', '3D Scene Graph', 'Shaders'] },
          { id: 'flutter', label: 'Flutter / Dart', position: [5.2, -6.2, 3.2], name: 'Flutter / Dart', category: 'Mobile / DevOps', usedIn: ['SightMate Mobile App'], tags: ['Cross-Platform UI', 'Mobile Apps'] },
          { id: 'nextjs', label: 'Git & GitHub', position: [9.2, -2.2, 0.8], name: 'Git & GitHub', category: 'Mobile / DevOps', usedIn: ['All Projects & Workflows'], tags: ['Version Control', 'DevOps', 'CI/CD'] },
        ],
      },
    ],
  },
